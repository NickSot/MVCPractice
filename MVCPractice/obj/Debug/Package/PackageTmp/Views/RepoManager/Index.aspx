...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <%if (Model.folderPath != Server.MapPath(@"~\wwroot\") && Model.folderPath != Server.MapPath(@"~\wwroot")) %>
    <%: Html.ActionLink("Previous folder", "EnterDir", new { folderPath = System.IO.Directory.GetParent(Model.folderPath) }, null)%>
    <br />
    <br />
